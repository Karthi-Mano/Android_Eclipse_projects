 ...
 */
public class TopStorySectionFragment extends Fragment {
	...
	private class GetDataFromFeed extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			try {
				final String feedUrl = "http://feeds.bbci.co.uk/news/rss.xml";
				...
				XMLHandler saxHandler = new XMLHandler(
						DatabaseHelper.NEWS_TYPE_TOP_STORIES);
		...
		protected void onPostExecute(Void result) {
			...
			listViewStory.setAdapter(new NewsAdapter(getActivity(), dbHelper
					.getNewsItems(DatabaseHelper.NEWS_TYPE_TOP_STORIES)));
