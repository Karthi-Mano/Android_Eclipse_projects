 ...
 */
public class WorldStorySectionFragment extends Fragment {
	...
	private class GetDataFromFeed extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			try {
				final String feedUrl = "http://feeds.bbci.co.uk/news/world/rss.xml";
				...
				XMLHandler saxHandler = new XMLHandler(
						DatabaseHelper.NEWS_TYPE_WORLD);
		...
		protected void onPostExecute(Void result) {
			...
			listViewStory.setAdapter(new NewsAdapter(getActivity(), dbHelper
					.getNewsItems(DatabaseHelper.NEWS_TYPE_WORLD)));
